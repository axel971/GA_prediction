...
def main():
    ...
    nFold = 10 # Initialize the number of fold 
    ...
    for iFold in range(nFold):
    	...
    	# Compute the training GA weights (per MRI direction) using kernel density estimation
    	...
    	model_axial.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/model_axial_' + str(iFold) + ".h5")
    	model_sagittal.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/model_sagittal_' + str(iFold) + ".h5")
    	model_coronal.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/model_coronal_' + str(iFold) + ".h5")
    	
    	# Applied the training models on the validation slices
    	...
    	# Compute the endpoints of the models on the validation slices
    ...
    # Compute the endpoints of the models on the whole cohort ...
    ...
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/GA.npy', GA)
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/GA_prediction.npy', GA_predictions)
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNet_slices2D/exp1/uncertainty.npy', uncertainty)
#    
