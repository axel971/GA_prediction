...
from model.model import ResNet34Attention_2D
...
def main():
    ...
    for iFold in range(nFold):
    	...
    	model_axial = ResNet34Attention_2D([image_size[0], image_size[1]] +[1])
    	model_sagittal = ResNet34Attention_2D([image_size[1], image_size[2]] +[1])
    	model_coronal = ResNet34Attention_2D([image_size[0], image_size[2]] +[1])

    		
    		
    	optimizer = optimizers.Adam(learning_rate=1e-3)
    	
    	#Compute the training GA weights per MRI direction
    	...
    	model_axial.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/model_axial_' + str(iFold) + ".h5")
    	model_sagittal.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/model_sagittal_' + str(iFold) + ".h5")
    	model_coronal.save_weights('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/model_coronal_' + str(iFold) + ".h5")
    ...
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/GA.npy', GA)
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/GA_prediction.npy', GA_predictions)
    np.save('/home/axel/dev/fetus_GA_prediction/data/output/deepEnsembleResNetAttention_slices2D/exp1/uncertainty.npy', uncertainty)
